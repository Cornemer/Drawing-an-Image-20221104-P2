...
void setup()
{
  ...
  //
  //Population
  pic = loadImage("../Images Used/Landscape/besho-meme.gif");
  ...
  println("Adjusted Image 1 dimesnions are (stretch is goal):", picWidthAdjusted, picHeightAdjusted);
  //

  println("App Width:", pic2Width, " and App Height:", appHeight);
  println("Larger Image dimension is:", widthLarger2, "or", heightLarger2);
  println("Image dimensions are:", topHalfWidth, topHalfHeight);
  println("Scale Ratios, width", "height is", imageHeightRatio2);
  println("Adjusted Image 2 dimesnions are (stretch is goal):", picWidthAdjusted2, picHeightAdjusted2);
  //
...
void draw()
{
  image( pic2, topHalfX, topHalfY, picHeightAdjusted2, picWidthAdjusted2 );
